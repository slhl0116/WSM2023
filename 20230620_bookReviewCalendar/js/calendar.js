...
const setCalendar = (year, month) => {
    ...
    var lastDate = new Date(year, month - 1 + 1, -1).getDate();
    ...
    for(let date=1; date<=lastDate; date++){
        ...
        // HTML에 .dates.container 자식으로 낳자 
        datesContainerDiv.appendChild(dateItemDiv);
    }

    // 1일을 firstDateDay로 옮기자      5 => 6
    // .dates.container의 자식 중 첫째 자식(1일) style grid-column-start: 6;
